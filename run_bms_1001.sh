...
var_decoder=softmax
var_lambda_rate=0.8
var_model_name=zen_memory_softmax_0_0.9_$var_lambda_rate
var_u_th=0.9
var_c_th=0
...
var_decoder=softmax
var_lambda_rate=0.8
var_model_name=zen_memory_softmax_0_1.1_$var_lambda_rate
var_u_th=1.1
var_c_th=0
...
var_decoder=softmax
var_lambda_rate=0.8
var_model_name=zen_memory_softmax_0_0.7_$var_lambda_rate
var_u_th=0.7
var_c_th=0

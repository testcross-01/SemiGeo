...
var_decoder=softmax
var_lambda_rate=0.8
var_model_name=zen_memory_softmax_un_$var_lambda_rate
var_u_th=0.8
var_c_th=0.7
...
#predict
python my_wmseg_main.py --do_predict --input_file=./data_preprocessing/mydata/larger/train.unseg --output_file=./data_preprocessing/mydata/larger/self_train.txt --output_file_tsv=./data_preprocessing/mydata/larger/self_train.tsv --eval_model=$CHECKPOINT_PATH --eval_batch_size=16 --u_th=$var_u_th --c_th=$var_c_th

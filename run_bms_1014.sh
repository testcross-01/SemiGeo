...
var_decoder=softmax
var_lambda_rate=0.8
var_model_name=bert_memory_softmax_0.5_$var_lambda_rate
var_u_th=100
var_c_th=0.5
...
var_decoder=softmax
var_lambda_rate=0.8
var_model_name=bert_memory_softmax_0.7_$var_lambda_rate
var_u_th=100
var_c_th=0.7
...
var_decoder=softmax
var_lambda_rate=0.8
var_model_name=bert_memory_softmax_0.9_$var_lambda_rate
var_u_th=100
var_c_th=0.9

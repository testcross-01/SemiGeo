...
bert_model_path=/opt/Projects/Models/bert-base-chinese
var_decoder=softmax
var_lambda_rate=0.8
var_model_name=bert_wm_av_3_score_0_$var_lambda_rate
var_u_th=100
var_c_th=0

python my_wmseg_main.py  --do_train --train_data_path=./data/mydata/larger/train.tsv --eval_data_path=./data/mydata/larger/dev.tsv --use_bert --use_memory --bert_model=$bert_model_path  --decoder=$var_decoder --max_seq_length=3  --decoder=softmax --max_seq_length=300 --max_ngram_size=300 --train_batch_size=16 --eval_batch_size=16 --num_train_epochs=50 --warmup_proportion=0.1 --learning_rate=1e-5 --ngram_num_threshold=3 --patient=10 --ngram_flag=av --av_threshold=1 --model_name=$var_model_name
...
#self train
python my_wmseg_main.py --do_train --self_train_data_path=./data_preprocessing/mydata/larger/self_train.tsv --lambda_rate=$var_lambda_rate --train_data_path=./data/mydata/larger/train.tsv --eval_data_path=./data/mydata/larger/dev.tsv --use_bert --use_memory --bert_model=$bert_model_path --decoder=$var_decoder --max_seq_length=300 --max_ngram_size=300 --train_batch_size=16 --eval_batch_size=16 --num_train_epochs=50 --warmup_proportion=0.1 --learning_rate=1e-5 --ngram_num_threshold=3 --patient=10 --ngram_flag=av --av_threshold=1 --model_name=self_$var_model_name_a
